...
const SocialIcon: React.FC<{ size: number }> = ({ size }) => (
  <svg width={size} height={size} viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const AssertivenessIcon: React.FC<{ size: number }> = ({ size }) => (
  <svg width={size} height={size} viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const PersistenceIcon: React.FC<{ size: number }> = ({ size }) => (
  <svg width={size} height={size} viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const icons: Record<Category, React.FC<{ size: number }>> = {
  ...
  social: SocialIcon,
  assertiveness: AssertivenessIcon,
  persistence: PersistenceIcon,
  relaxation: RegulationIcon,
  'self-esteem': AutonomyIcon,
};
